...
//     { id: 'BlogPost', title: 'Blog Post Conclusion', description: 'Wrap up your blog posts with an engaging conclusion paragraph.' },
...
//   boxShadow: '0px 6px 20px rgba(0, 0, 0, 0.2)',
//   border: '2px solid rgba(77, 238, 253, 0.7)',
//   backgroundImage: 'linear-gradient(112.1deg, rgb(77, 238, 253) 0.7%, rgb(3, 151, 232) 26.1%, rgb(47, 31, 116) 95.7%)',
//   color: 'white',
// };
...
//     @media (max-width: 768px) {
//       <CardContent className="card-content">
//         <Typography variant="h5" component="div" style={{ fontSize: '20px', fontWeight:'bold', color: isHovered(card.id) ? 'white' : 'black', textAlign: 'center'}}>
//           {card.title}
//         </Typography>
//         <Typography variant="body2" className="hide-on-mobile" style={{ fontSize: '12px', color: isHovered(card.id) ? 'white' : 'black' }}>
//           {card.description}
//         </Typography>
//       </CardContent>
...
//           >
//             <CardContent className="card-content">
//               <Typography variant="h5" component="div" style={{ fontSize: '20px',color: isHovered(card.id) ? 'white' : 'black' }}>
//                 {card.title}
//               </Typography>
//               <Typography variant="body2" className="hide-on-mobile" style={{ fontSize: '12px', color: isHovered(card.id) ? 'white' : 'black' }}>
//                 {card.description}
  ...
  return (
    <div className="container-for-cards">
      {cards.map((card) => (
        ...
        >
          <CardContent className="card-content">
            <Typography variant="h5" component="div" className={`title ${isHovered(card.id) ? 'hovered' : ''}`}>
              {card.title}
            </Typography>
            <Typography variant="body2" className={`description ${isHovered(card.id) ? 'hovered' : ''}`}>
              {card.description}
            </Typography>
          </CardContent>
        </div>
