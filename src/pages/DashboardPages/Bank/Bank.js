...
const CardListComponent = () => {
  ...
  return (
    <div className="bank-card-list">
      {cards.map((card) => (
        <div key={card.id} className="bank-card" onClick={() => handleClickOpen(card.description)}>
